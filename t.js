...
function uploadFiles(pdfFile, audioFile) {
    ...
    fetch('https://audiotranscriptsummarizer-a7erbkb8ftbmdghf.eastus-01.azurewebsites.net:8000/process', {
        method: 'POST',
        body: formData
    })
    .then(response => {
...
function generateSummary() {
    ...
    fetch('https://audiotranscriptsummarizer-a7erbkb8ftbmdghf.eastus-01.azurewebsites.net:8000/summarize', {
        method: 'POST',
        body: formData
    })
...
function generateQAOneLinerSummary() {
    ...
    fetch('https://audiotranscriptsummarizer-a7erbkb8ftbmdghf.eastus-01.azurewebsites.net:8000/qa_one_liner_summary', {
        method: 'POST',
...
function processCorrectedText(correctedText) {
    ...
    fetch('https://audiotranscriptsummarizer-a7erbkb8ftbmdghf.eastus-01.azurewebsites.net:8000/process-corrected-text', {
        method: 'POST',
        headers: {
...
function askQuestion(question) {
    ...
    fetch('https://audiotranscriptsummarizer-a7erbkb8ftbmdghf.eastus-01.azurewebsites.net:8000/ask-question', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
